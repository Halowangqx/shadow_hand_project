...
class leap_message {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('palm_position')) {
        this.palm_position = initObj.palm_position
      }
      else {
        this.palm_position = [];
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [palm_position]
    bufferOffset = _arraySerializer.float64(obj.palm_position, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [palm_position]
    data.palm_position = _arrayDeserializer.float64(buffer, bufferOffset, null)
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 8 * object.palm_position.length;
    return length + 20;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.palm_position !== undefined) {
      resolved.palm_position = msg.palm_position;
    }
    else {
      resolved.palm_position = []
    }
