...
message(STATUS "leap_motion: 1 messages, 0 services")

set(MSG_I_FLAGS "-Ileap_motion:/home/luhr/shadow_hand_ros/src/leap_motion/msg;-Igeometry_msgs:/opt/ros/noetic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/noetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/luhr/shadow_hand_ros/src/leap_motion/msg/leap_message.msg" NAME_WE)
add_custom_target(_leap_motion_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "leap_motion" "/home/luhr/shadow_hand_ros/src/leap_motion/msg/leap_message.msg" "std_msgs/Header"
)
...
_generate_msg_cpp(leap_motion
  "/home/luhr/shadow_hand_ros/src/leap_motion/msg/leap_message.msg"
  "${MSG_I_FLAGS}"
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/leap_motion)
  install(CODE "execute_process(COMMAND \"/usr/bin/python3\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/leap_motion\")")
  # install generated code
  install(
